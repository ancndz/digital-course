package ru.ancndz.digitalcourse.views.chat;
...
@PageTitle(ChatView.PAGE_TITLE)
@Route(value = "chat", layout = MainLayout.class)
public class ChatView extends VerticalLayout {

    public static final String PAGE_TITLE = "Беседа";
    ...
    public ChatView() {
        ...
        UserInfo userInfo = new UserInfo(UUID.randomUUID().toString(), "Аноним");

        // Tabs allow us to change chat rooms.
        Tabs tabs = new Tabs(new Tab("#общее"),
                new Tab("#лекции"),
                new Tab("#практика"),
                new Tab("#важное"));
        tabs.setWidthFull();
        ...
        // server restarts.
        CollaborationMessageList list = new CollaborationMessageList(userInfo, "chat/#общее");
        list.setWidthFull();
